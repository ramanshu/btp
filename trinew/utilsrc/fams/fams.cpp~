...
void clusterTranformationData(int K,int L,int k,char* data_file_name,char* input_path,int jump,float percent,float width, float epsilon,int Kmin,int Kjump)
{
   int no_lsh, find_kl;
   int K, L, k_neigh;
